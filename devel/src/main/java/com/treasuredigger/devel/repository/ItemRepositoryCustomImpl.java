...
import com.treasuredigger.devel.dto.QMainItemDto;
import com.treasuredigger.devel.entity.Item;
import com.treasuredigger.devel.entity.QItem;
import com.treasuredigger.devel.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom{
    ...
    public Page<MainItemDto> getMainItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        ...
        List<MainItemDto> content = queryFactory
                ...
                .orderBy(item.itemSellStatus.asc(),
                        item.id.desc())
                .offset(pageable.getOffset())
                .limit(pageable.getPageSize())
                .fetch();
